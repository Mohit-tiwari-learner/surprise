...
import { AlertTriangle, ChevronDown, Volume2, VolumeX, Terminal as TermIcon, Heart, CheckCircle2, Image as ImageIcon, ArrowRight, Sparkles, ArrowDown, Plus, ChevronLeft, ChevronRight, Smile, Mail } from "lucide-react";
...
export default function ProposalPage() {
  ...
  return (
    <div ref={pageContainerRef} className="min-h-screen relative font-sans select-none overflow-x-hidden">
      ...
      <button
        onClick={toggleSound}
        className="fixed top-4 right-4 z-[10000] p-2.5 rounded-full border bg-black/40 border-white/10 backdrop-blur-md hover:bg-white/10 transition-all cursor-pointer text-white flex items-center justify-center"
        aria-label="Toggle audio"
      >
        {muted ? <VolumeX className="w-5 h-5 text-gray-400" /> : <Volume2 className="w-5 h-5 text-cyber-red animate-pulse" />}
      </button>
          ...
          {terminalPage === 1 && (
            <div className="flex-1 flex flex-col items-center justify-center max-w-lg w-full text-center gap-8 animate-[fadeIn_0.5s_ease-out]">
              <div className="space-y-2 select-none">
                <h1 className="text-5xl md:text-6xl font-bold tracking-wider uppercase font-space glow-red glitch-text" data-text="SYSTEM ALERT">
                  SYSTEM ALERT
                </h1>
              ...
              {/* Warning Card */}
              <div className="w-full border-2 border-cyber-red bg-cyber-red/5 glow-red-border p-6 rounded-md space-y-4 animate-[pulse_2s_infinite]">
          ...
          {terminalPage === 2 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 p-6 md:p-8 font-mono text-xs md:text-sm">
                ...
                <div className="md:col-span-8 flex flex-col justify-between h-[360px] md:h-[400px]">
          ...
          {terminalPage === 3 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 p-6 md:p-8 font-mono text-xs md:text-sm">
                ...
                <div className="md:col-span-7 flex flex-col justify-between h-[360px] md:h-[400px]">
                ...
                <div className="md:col-span-5 flex flex-col items-center justify-between h-[360px] md:h-[400px] py-4">
      ...
      {/* ======================================================== */}
      {act === 3 && (
        <div className="min-h-screen bg-white text-zinc-900 selection:bg-pink-100 relative">
          ...
          <header className="fixed top-0 left-0 w-full p-6 flex justify-between items-center z-[100] mix-blend-difference font-mono text-[10px] md:text-xs text-black uppercase tracking-wider">
            <span>project_yasha.exe</span>
            {(() => {
              const displayBPM = isYashaHovered ? 138 : yesClicked ? 145 : bloomActive ? 98 : 72;
              return (
                <span className="flex items-center gap-1.5 font-bold text-pink-500">
                  ...
                  System Status : In Love ({displayBPM} BPM)
                </span>
              );
            })()}
          </header>
          ...
          {/* PAGE 5: BEFORE YOU             */}
          {/* ============================== */}
          <section className={`h-screen relative flex flex-col items-center justify-center p-6 z-10 transition-all duration-1000 ${
            isYashaHovered ? "bg-zinc-950 text-white" : "bg-white text-zinc-900"
          }`}>
            ...
            <div 
              ...
              className="absolute -left-20 top-20 w-80 h-40 bg-pink-100/20 rounded-full filter blur-3xl opacity-60 animate-[float_8s_infinite_ease-in-out] z-0" 
            />
            <div 
              style={{
                transform: `translate(${mousePos.x * 0.9}px, ${mousePos.y * 0.9}px)`,
              ...
              className="absolute -right-20 bottom-20 w-96 h-50 bg-pink-100/20 rounded-full filter blur-3xl opacity-60 animate-[float_10s_infinite_ease-in-out_1s] z-0" 
            />
            ...
            <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10 relative">
              ...
              <div 
                ...
                className="md:col-span-6 text-center md:text-left space-y-10"
              >
                <h2 className={`font-editorial text-5xl md:text-7xl lg:text-8xl tracking-tight leading-none select-none transition-all duration-700 ${
                  isYashaHovered ? "text-white" : "text-zinc-900"
                }`}>
                  Before you,<br />
                  life was <span className="normal-word text-pink-500 font-editorial-body italic font-medium">normal</span>.
                </h2>
                
                <div className={`font-editorial-body text-xl md:text-2xl lg:text-3xl max-w-xl mx-auto md:mx-0 space-y-6 leading-relaxed select-none transition-all duration-700 ${
                  isYashaHovered ? "text-zinc-400" : "text-zinc-500"
                }`}>
                  <p className="animate-[fadeIn_1s_ease-out_0.5s_both]">
                    Just another boy,<br />
                    living in a world full of people<br />
                    and empty of meaning.
                  </p>
                  
                  <p className={`font-semibold pt-6 text-2xl md:text-3xl lg:text-4xl animate-[fadeIn_1s_ease-out_1.5s_both] transition-all duration-700 ${
                    isYashaHovered ? "text-zinc-200" : "text-zinc-800"
                  }`}>
                    Then one day...<br />
                    a girl named <span onMouseEnter={handleYashaMouseEnter} onMouseLeave={handleYashaMouseLeave} className="yasha-name text-pink-500 border-b-4 border-pink-200 px-2 font-editorial italic text-3xl md:text-4xl lg:text-5xl">Yasha</span> appeared.
                  </p>
                </div>
              </div>

              {/* Right Column: Illustration (Col 6) */}
              <div className="md:col-span-6 flex items-center justify-center h-[400px] md:h-[620px] lg:h-[720px] relative">
                <img
                  src="/boy.png"
                ...
                <img
                  ...
                  className={`absolute h-full object-contain transition-all duration-1000 ease-in-out rounded-2xl ${
            ...
            <div className="absolute bottom-8 flex flex-col items-center gap-1 text-[10px] font-mono tracking-widest text-zinc-400 uppercase z-10">
              <span>Scroll down</span>
              <ChevronDown className="w-4 h-4 bounce text-pink-400" />
            </div>
          </section>
          ...
          <section
            ref={bloomSectionRef}
            className={`h-screen relative flex flex-col items-center justify-center p-6 z-10 transition-all duration-[1500ms] ${
              bloomActive ? "bg-[#fff8fa]" : "bg-white grayscale saturate-0 opacity-50"
            }`}
          >
            {/* Header Content */}
            <div className="text-center space-y-4 mb-10 select-none animate-[fadeIn_1s_ease-out]">
              <h2 className="font-editorial text-4xl md:text-6xl tracking-tight text-zinc-800 leading-tight">
                And suddenly,<br />
                everything changed.
              </h2>
              ...
              {/* Subheading */}
              <p className="font-mono text-xs md:text-sm tracking-widest text-zinc-500 uppercase">
                The story of Yasha — before and <span className="text-pink-500 font-bold">after</span>.
              </p>
            </div>

            {/* Cards Grid with Center Connector */}
            <div className="relative w-full max-w-4xl mx-auto px-4 md:px-8 py-4 flex flex-col md:flex-row items-stretch justify-center gap-10 md:gap-16">
              ...
              <div className={`flex-1 bg-white/80 border border-zinc-200/60 shadow-[0_15px_30px_rgba(0,0,0,0.02)] rounded-[2rem] p-6 md:p-8 flex flex-col justify-between transition-all duration-700 hover:scale-[1.02] hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] relative group z-10 ${
                bloomActive ? "opacity-100" : "opacity-40"
              }`}>
                <div className="space-y-6">
                  {/* Badge */}
                  <div>
                    <span className="inline-block px-3.5 py-1 bg-zinc-100 rounded-full font-mono text-[9px] font-bold tracking-widest text-zinc-400 border border-zinc-200/30">
                      BEFORE YASHA
                    </span>
                  </div>
                  
                  {/* Title */}
                  <h3 className="font-editorial text-2xl md:text-3xl italic text-zinc-400 font-normal leading-tight">
                    A monochrome world
                  </h3>
                  
                  {/* Paragraph */}
                  <p className="font-editorial-body text-zinc-400 text-sm md:text-base leading-relaxed text-left">
                ...
                {/* Footer */}
                <div className="flex items-center gap-3 mt-10 text-zinc-400/90 select-none">
                  <div className="w-9 h-9 rounded-full border border-zinc-200 flex items-center justify-center bg-zinc-50/50">
                    <ImageIcon className="w-4 h-4" />
                  </div>
                  <span className="font-mono text-[10px] uppercase tracking-wider font-semibold">View chapter</span>
              ...
              <div className={`flex-1 backdrop-blur-md flex flex-col justify-between transition-all duration-700 hover:scale-[1.02] relative group z-10 ${
                bloomActive 
                  ? "bg-pink-50/40 border border-pink-200/80 shadow-[0_15px_30px_rgba(244,63,94,0.06),0_0_15px_rgba(255,182,193,0.15)] hover:shadow-[0_20px_40px_rgba(244,63,94,0.12),0_0_20px_rgba(255,182,193,0.25)] rounded-[2rem] p-6 md:p-8" 
                  : "bg-white border border-zinc-200/60 shadow-[0_15px_30px_rgba(0,0,0,0.02)] rounded-[2rem] p-6 md:p-8 opacity-40"
              }`}>
                {/* Floating sparkle badge in top right (only when active) */}
                {bloomActive && (
                  <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-pink-500 flex items-center justify-center shadow-md shadow-pink-200 z-20 animate-[float_4s_infinite_ease-in-out]">
                ...
                <div className="space-y-6">
                  {/* Badge */}
                  <div>
                    <span className={`inline-block px-3.5 py-1 rounded-full font-mono text-[9px] font-bold tracking-widest border transition-all duration-700 ${
                      bloomActive 
                        ? "bg-pink-100/60 text-pink-500 border-pink-200/40" 
                        : "bg-zinc-100 text-zinc-400 border-zinc-200/30"
                    }`}>
                      AFTER YASHA
                    </span>
                  </div>
                  ...
                  {/* Title */}
                  <h3 className={`font-editorial text-2xl md:text-3xl italic font-normal leading-tight transition-colors duration-700 ${
                    bloomActive ? "text-pink-600 font-medium" : "text-zinc-400"
                  }`}>
                    A beautiful pink bloom
                  </h3>
                  
                  {/* Paragraph */}
                  <p className={`font-editorial-body text-sm md:text-base leading-relaxed text-left transition-colors duration-700 ${
                    bloomActive ? "text-zinc-700" : "text-zinc-400"
                  }`}>
                ...
                {/* Footer */}
                <div className={`flex items-center gap-3 mt-10 transition-colors duration-700 select-none ${
                  bloomActive ? "text-pink-500" : "text-zinc-400"
                }`}>
                  <div className={`w-9 h-9 rounded-full border flex items-center justify-center transition-all duration-700 ${
                    bloomActive ? "border-pink-200 bg-pink-50/50" : "border-zinc-200 bg-zinc-50/50"
                  }`}>
                    <ImageIcon className="w-4 h-4" />
                  </div>
                  <span className="font-mono text-[10px] uppercase tracking-wider font-semibold">View chapter</span>
          ...
          {/* ============================== */}
          <section className="h-screen relative flex flex-col items-center justify-center py-10 px-6 z-10 bg-white">
            <div className="max-w-5xl w-full text-center space-y-8 relative">
              <div className="space-y-4">
                {/* Reasons.exe badge */}
                <div className="flex items-center justify-center gap-2 font-mono text-xs uppercase tracking-widest text-pink-500 font-semibold">
                ...
                {/* Title */}
                <h2 className="font-editorial text-4xl md:text-6xl tracking-tight text-zinc-800 leading-[1.2] relative max-w-2xl mx-auto select-none">
                  {/* Left hand-drawn sparks */}
                  <span className="absolute left-[-2rem] md:left-[-3.5rem] top-[45%] -translate-y-1/2 text-pink-400 hidden sm:inline-block rotate-[-15deg] animate-[pulse_2s_infinite]">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                      <path d="M5 12h3M7 8l2 2M10 6v3" />
                    </svg>
                  </span>
                  Why you make{" "}
                  <svg className="w-9 h-9 md:w-12 md:h-12 text-pink-400 fill-none stroke-[1.5] inline-block ml-1 align-middle rotate-12 animate-[pulse_1.5s_infinite]" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {/* Subtitle */}
                <p className="font-mono text-zinc-400 text-xs md:text-sm tracking-wide italic select-none">
              ...
              <div className="flex items-center justify-center gap-2 md:gap-6 max-w-5xl mx-auto w-full pt-4 relative px-2 md:px-6">
                ...
                {/* Cards Container */}
                <div 
                  className="flex-1 py-4 flex flex-col md:flex-row items-stretch justify-center gap-3 md:gap-4 max-w-4xl mx-auto w-full h-[520px] md:h-[400px] overflow-hidden"
                >
                  {[
                    { 
                      id: "01.exe", 
                      ...
                      icon: <Smile className="w-8 h-8 md:w-10 md:h-10 text-pink-500 stroke-[1.5]" />,
                      bgGradient: "from-pink-50/20 to-rose-50/20"
                    },
                    { 
                      id: "02.exe", 
                      title: "Your Voice", 
                      desc: "It's my favorite sound in the world.",
                      icon: (
                        <svg className="w-8 h-8 md:w-10 md:h-10 text-pink-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                    ...
                    { 
                      ...
                      icon: <Heart className="w-8 h-8 md:w-10 md:h-10 text-pink-500 fill-none stroke-[1.5]" />,
                    ...
                    { 
                      ...
                      icon: (
                        <svg className="w-8 h-8 md:w-10 md:h-10 text-pink-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-[2rem] p-5 md:p-6 text-center flex flex-col justify-between cursor-pointer transition-all duration-700 relative group overflow-hidden select-none border ${
                          isActive 
                            ? "flex-[3.5] bg-white border-pink-300 shadow-[0_20px_45px_rgba(244,63,94,0.08)] scale-100 z-10" 
                            : "flex-[0.8] bg-zinc-50/70 hover:bg-pink-50/20 border-zinc-200/50 scale-100 opacity-90 z-0"
                        }`}
                      >
                        ...
                        <div className="w-full flex justify-between items-center relative z-10">
                          <span className={`font-mono text-[9px] font-bold tracking-widest uppercase transition-colors duration-500 ${
                            isActive ? "text-pink-500" : "mx-auto md:mx-0 text-zinc-400"
                          }`}>
                            {reason.id}
                          </span>
                        </div>
                        ...
                        {isActive ? (
                          ...
                          <div className="flex-1 flex flex-col items-center justify-center space-y-6 relative z-10 animate-[fadeIn_0.5s_ease-out]">
                            {/* Large pulsing icon */}
                            <div className="w-24 h-24 rounded-full bg-pink-50/80 flex items-center justify-center shadow-[0_0_25px_rgba(255,182,193,0.3)] animate-[pulse_3s_infinite]">
                              <div className="scale-[1.8]">{reason.icon}</div>
                            </div>
                          </div>
                        ) : (
                          ...
                          <div className="flex-1 flex items-center justify-center relative z-10 py-4">
                            <span className="font-mono text-[9px] md:text-[10px] font-bold tracking-[0.2em] text-zinc-400 uppercase md:[writing-mode:vertical-rl] md:rotate-180 select-none pointer-events-none">
                              {reason.title}
                            </span>
                          </div>
                        )}
                        ...
                        <div className="w-full relative z-10">
                          {isActive ? (
                            ...
                            <div className="flex items-end justify-between text-left pt-2 border-t border-pink-100/50 animate-[fadeIn_0.5s_ease-out]">
                              <div className="space-y-1 pr-4">
                                <h3 className="font-editorial text-lg md:text-xl font-semibold text-zinc-800 leading-snug">
                                  {reason.title}
                                </h3>
                                <p className="font-editorial-body text-xs text-zinc-500 leading-normal max-w-[200px] md:max-w-[240px]">
                                  {reason.desc}
                                </p>
                              </div>
                              
                              {/* Arrow Button */}
                              <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-pink-500 text-white flex items-center justify-center shadow-md shadow-pink-100 hover:bg-pink-600 transition-all duration-300 transform scale-105 flex-shrink-0">
                                <ArrowRight className="w-4 h-4" />
                              </div>
                            </div>
                          ) : (
                            /* Collapsed Footer Layout (Centered Icon) */
                            <div className="flex justify-center pt-2">
                              <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white border border-zinc-200 text-pink-400 flex items-center justify-center shadow-sm group-hover:border-pink-200 group-hover:bg-pink-50/20 transition-all duration-300">
                                {reason.icon}
                              </div>
                            </div>
                          )}
          ...
          {/* ============================== */}
          <section className="h-screen relative flex flex-col items-center justify-center text-center p-6 z-10 bg-gradient-to-b from-white to-pink-50/30">
            ...
            <div className="max-w-2xl space-y-12 relative">
              ...
              <div className="space-y-4">
                <h2 className="font-editorial text-5xl md:text-7xl tracking-tight leading-none text-zinc-900 select-none">
                  Will You Be<br />
                  My Forever?
                </h2>
                <p className="font-editorial-body text-zinc-500 text-lg md:text-xl italic">
              ...
              <div className="flex flex-row items-center justify-center gap-6 pt-4 h-16 relative">
                <button
                  onClick={handleYes}
                  className="px-10 py-4 bg-pink-500 hover:bg-pink-600 text-white font-mono font-bold tracking-widest cursor-pointer text-sm uppercase rounded-full shadow-md hover:shadow-pink-200 transition-all active:scale-95 duration-200 relative z-10"
                >
                  [ Y E S ]
                </button>
                ...
                <button
                  ...
                  className="px-10 py-4 border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-400 font-mono tracking-widest cursor-pointer text-sm uppercase rounded-full shadow-sm select-none relative z-10"
                >
            ...
            {yesClicked && (
              <div className="fixed inset-0 z-[1000] bg-pink-50/95 flex flex-col items-center justify-center p-6 animate-[fadeIn_0.6s_ease-out] select-text">
                <FireworkCelebration />
                
                <div className="max-w-xl w-full bg-white/95 border border-pink-200 shadow-xl rounded-3xl p-8 md:p-12 text-center space-y-8 relative z-10 backdrop-blur-md animate-[scaleUp_0.5s_cubic-bezier(0.175,0.885,0.32,1.275)]">
                  <div className="flex justify-center">
                    <CheckCircle2 className="w-16 h-16 text-pink-500 animate-[bounce_1.5s_infinite]" />
                  </div>
                  
                  <div className="space-y-3">
                    <h3 className="font-mono text-xs uppercase tracking-widest text-pink-500 font-bold border border-pink-100 rounded-full px-4 py-1.5 inline-block bg-pink-50/50">
                      Mission Successful
                    </h3>
                    <h4 className="font-editorial text-3xl md:text-4xl text-zinc-800">
                      Forever Locked In ❤️
                    </h4>
                  </div>

                  <div className="border border-pink-100 bg-pink-50/30 rounded-2xl p-5 text-left font-mono text-xs md:text-sm space-y-2.5 text-zinc-600 max-w-sm mx-auto">
                    <div className="flex justify-between border-b border-pink-100/50 pb-2">
                      <span className="text-zinc-400">Project:</span>
                      <span className="font-semibold text-zinc-800">yasha_proposal.exe</span>
                    </div>
                    <div className="flex justify-between border-b border-pink-100/50 pb-2">
                      <span className="text-zinc-400">Connection Status:</span>
                      <span className="font-bold text-pink-500 uppercase">Forever</span>
                    </div>
                    <div className="flex justify-between pb-1">
                      <span className="text-zinc-400">Execution status:</span>
                      <span className="font-bold text-green-500 uppercase">Completed Successfully</span>
                    </div>
                  </div>

                  <p className="font-editorial-body text-zinc-500 italic max-w-xs mx-auto">
                    "I love you in all iterations, at all coordinates, forever."
                  </p>
                  ...
                  <button
                    ...
                    className="font-mono text-xs text-pink-400 hover:text-pink-600 border border-pink-100 hover:border-pink-300 rounded-full px-4 py-2 hover:bg-pink-50 transition-all cursor-pointer mt-4"
                  >
                    Replay the code.exe
                  </button>
                </div>
          ...
          <button
            ...
            className="fixed bottom-6 left-6 z-[100] w-12 h-12 rounded-full bg-white border border-pink-100 hover:border-pink-200 text-pink-500 hover:text-pink-600 flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-all cursor-pointer"
          ...
          {isLetterOpen && (
            ...
            >
              <div 
                className="bg-white/95 border border-pink-200/60 p-8 md:p-12 rounded-[2.5rem] max-w-md w-full shadow-2xl relative text-center space-y-6 animate-[scaleUp_0.4s_cubic-bezier(0.175,0.885,0.32,1.275)] select-text"
